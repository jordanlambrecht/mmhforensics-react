          ...
          <div className='row '>
            <div className='col-12 col-md-6 form-floating mb-4'>
              <input
                ref={(node) => (fname = node)}
                type='text'
                className='form-control teamform ring-white focus:border-2 focus:border-white focus:ring-2 ring'
                id='mce-FNAME'
                name='FNAME'
              ...
              />
              <label className='ps-3 ms-2' htmlFor='mce-FNAME'>
                First Name
              </label>
            </div>
            ...
            <div className='col-12 col-md-6 form-floating mb-4'>
              <input
                ...
                value={status === "success" ? "" : undefined}
              />
              <label className='ps-3 ms-2' htmlFor='mce-LNAME'>
                Last Name
              </label>
            </div>
          </div>
